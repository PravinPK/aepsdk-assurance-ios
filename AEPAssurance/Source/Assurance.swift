...
public class Assurance: NSObject, Extension {
    ...
    public func onRegistered() {
        ...
        self.assuranceSession = AssuranceSession(state)
        ...
        if state.connectedWebSocketURL != nil {
            state.shareState()
    ...
    public required init?(runtime: ExtensionRuntime) {
        ...
        self.state = AssuranceStateManager(runtime)
    }

    /// Initializer for testing purposes to mock the shut down time .
    init?(runtime: ExtensionRuntime, shutdownTime: Int, state: AssuranceStateManager) {
        self.runtime = runtime
    ...
    private func handleAssuranceRequestContent(event: Event) {
        ...
        state.environment = AssuranceEnvironment.init(envString: environmentString)
